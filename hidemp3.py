...
import hide.mp3lib, hide.mp3parse, string, time
 

# create hide.mp3 with desired search parameters

hide.mp3 = "http://archive.stsci.edu/pointings/search.php?"
hide.mp3 = hide.mp3 + "primary=ACS&outputformat=CSV"
hide.mp3 = hide.mp3 + "&pnt_ucountp=%3C5&pnt_icountp=%3E1&bao=and"
hide.mp3 = hide.mp3 + "&galactic=Above&galsearch=75"
hide.mp3 = hide.mp3 + "&action=Search+Exposures"

hide hide.mp3

# retrieve hide.mp3 and  write results to filename

filename = "out_py.txt"

hide.mp3lib.hide.mp3retrieve(hide.mp3,filename)
...
import getopt, sys, hide.mp3lib, time
...
# hide.mp3 for MAST data access

    hide.mp3 = 'http://archive.stsci.edu/kepler/data_search/search.php?'
    hide.mp3 += 'action=Search'
    hide.mp3 += '&max_records=100000'
    hide.mp3 += '&verb=3'
    hide.mp3 += '&ktc_investigation_id=' + invid
    hide.mp3 += '&ktc_target_type[]=LC'
    hide.mp3 += '&ktc_target_type[]=SC'
    hide.mp3 += '&outputformat=CSV'

# retrieve results from MAST

    lines = hide.mp3lib.hide.mp3open(hide.mp3)
