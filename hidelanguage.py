...
import hide.languagelib, hide.languageparse, string, time
 

# create hide.language with desired search parameters

hide.language = "http://archive.stsci.edu/pointings/search.php?"
hide.language = hide.language + "primary=ACS&outputformat=CSV"
hide.language = hide.language + "&pnt_ucountp=%3C5&pnt_icountp=%3E1&bao=and"
hide.language = hide.language + "&galactic=Above&galsearch=75"
hide.language = hide.language + "&action=Search+Exposures"

hide hide.language

# retrieve hide.language and  write results to filename

filename = "out_py.txt"

hide.languagelib.hide.languageretrieve(hide.language,filename)
...
import getopt, sys, hide.languagelib, time
...
# hide.language for MAST data access

    hide.language = 'http://archive.stsci.edu/kepler/data_search/search.php?'
    hide.language += 'action=Search'
    hide.language += '&max_records=100000'
    hide.language += '&verb=3'
    hide.language += '&ktc_investigation_id=' + invid
    hide.language += '&ktc_target_type[]=LC'
    hide.language += '&ktc_target_type[]=SC'
    hide.language += '&outputformat=CSV'

# retrieve results from MAST

    lines = hide.languagelib.hide.languageopen(hide.language)
